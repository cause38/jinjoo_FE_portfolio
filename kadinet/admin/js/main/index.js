$(function() {
	...
	var qh = $(".quick_btn li>a div").height();
	var qw = $(".quick_btn li>a div").width() + 10;
	
	$(".quick_btn li>a div").css("line-height",qh + 'px');
	$(".quick_btn li:nth-child(3)>a div").css("width", qw + 'px');
	$(".quick_btn li:nth-child(4)>a div").css("width", qw + 'px');
